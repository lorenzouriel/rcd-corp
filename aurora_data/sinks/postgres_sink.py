"""PostgreSQL output sink for Aurora Corp data generator."""
...
DEFAULT_URL = "postgresql+psycopg2://aurora:aurora@localhost:5432/aurora_corp"


class PostgresSink:
    def __init__(self, connection_url: str | None = None) -> None:
        url = connection_url or os.environ.get("AURORA_POSTGRES_URL", DEFAULT_URL)
