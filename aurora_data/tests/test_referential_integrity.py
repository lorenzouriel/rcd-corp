"""Referential integrity tests for Aurora Corp generated data.

Run after generation:
    python -m pytest aurora_data/tests/test_referential_integrity.py -v
...
OUTPUT_DIR = os.environ.get("AURORA_OUTPUT_DIR", "./output")
FORMAT = os.environ.get("AURORA_OUTPUT_FORMAT", "parquet")
