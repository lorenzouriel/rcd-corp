"""Sales & e-commerce generator for Aurora Corp — the reference OrdersGenerator implementation."""
...
PAYMENT_METHODS = ["credit_card", "debit_card", "pix", "boleto", "paypal", "aurora_card", "bnpl"]
...
PROMO_CODES = [None, None, None, None, None, "AURORA10", "BF2024", "SUMMER15", "FIDELIDADE20"]
