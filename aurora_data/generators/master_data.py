"""Master data generator for Aurora Corp: customers, products, employees, suppliers, stores, warehouses, fx_rates."""
...
NAMED_STORES = [
    ("Aurora Paulista", "BR", "São Paulo", "SP", "flagship"),
    ("Aurora Ipanema", "BR", "Rio de Janeiro", "RJ", "flagship"),
    ("Aurora Reforma", "MX", "Mexico City", "CDMX", "flagship"),
    ("Aurora Chiado", "PT", "Lisbon", "LX", "flagship"),
    ("Aurora Brickell", "US", "Miami", "FL", "flagship"),
]


class MasterDataGenerator(BaseGenerator):
    """Generates all master data tables and populates MasterCache."""
    ...
    def _build_products(self, profile: ProfileConfig, suppliers: pd.DataFrame) -> pd.DataFrame:
        ...
        for name, brand, category, subcategory, price_brl in AURORA_PRODUCTS:
        ...
        n_third_party = min(profile.n_products - len(AURORA_PRODUCTS), 200)
