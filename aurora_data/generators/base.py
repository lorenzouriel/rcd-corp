"""Base generator, MasterCache, ProfileConfig, and SinkDispatcher for Aurora Corp."""
...
class BaseGenerator(ABC):
    """Abstract base for all Aurora Corp data generators."""
...
class SinkDispatcher:
    ...
    def from_flag(cls, flag: str, cfg: ProfileConfig, full_config: dict) -> "SinkDispatcher":
        ...
        postgres_url = output.get("postgres_url") or os.environ.get("AURORA_POSTGRES_URL")
