"""Customer support generator for RCD Corp: tickets, messages, call center."""
...
class SupportGenerator(BaseGenerator):
    ...
    def _build_calls(
        ...
        return pd.DataFrame({
            ...
            "created_at": created,
            "recording_url": [f"https://recordings.rcd.internal/{new_uuid()}.mp3" if self.rng.random() < 0.70 else None for _ in range(n)],
