"""Finance & accounting generator for RCD Corp."""
...
class FinanceGenerator(BaseGenerator):
    """Generates invoices, transactions, expenses, budgets, rcd_card_transactions."""
    ...
    def generate(
        ...
        return {
            ...
            "rcd_card_transactions": self._build_card_transactions(cache, profile, scale),
        }
    ...
    def _build_invoices(self, cache: MasterCache, profile: ProfileConfig, scale: int) -> pd.DataFrame:
        ...
        return pd.DataFrame({
            ...
            "payment_method": weighted_choice(
                ["credit_card", "pix", "boleto", "rcd_card"], [0.4, 0.3, 0.2, 0.1], n, self.rng
            ),
        })
